...
add wave -noupdate -color Brown -itemcolor Brown -expand -subitemconfig {{/fifo_to_axis_testbench/tdata_interface/valid_buffer[3]} {-color Brown -height 15 -itemcolor Brown} {/fifo_to_axis_testbench/tdata_interface/valid_buffer[2]} {-color Brown -height 15 -itemcolor Brown} {/fifo_to_axis_testbench/tdata_interface/valid_buffer[1]} {-color Brown -height 15 -itemcolor Brown} {/fifo_to_axis_testbench/tdata_interface/valid_buffer[0]} {-color Brown -height 15 -itemcolor Brown}} /fifo_to_axis_testbench/tdata_interface/valid_buffer
add wave -noupdate -color Brown -itemcolor Brown -expand -subitemconfig {{/fifo_to_axis_testbench/tdata_interface/eof_buffer[3]} {-color Brown -height 15 -itemcolor Brown} {/fifo_to_axis_testbench/tdata_interface/eof_buffer[2]} {-color Brown -height 15 -itemcolor Brown} {/fifo_to_axis_testbench/tdata_interface/eof_buffer[1]} {-color Brown -height 15 -itemcolor Brown} {/fifo_to_axis_testbench/tdata_interface/eof_buffer[0]} {-color Brown -height 15 -itemcolor Brown}} /fifo_to_axis_testbench/tdata_interface/eof_buffer
